...
const Card = ({ heading }: { heading: string }) => {
  return (
    <div
      data-dui-toggle="modal"
      data-dui-target="#exampleModal"
      className="flex items-center justify-center lg:h-40 lg:w-60 sm:h-10 sm:w-16 backdrop-blur-md duration-300 ease-in-out cursor-pointer"
    >
